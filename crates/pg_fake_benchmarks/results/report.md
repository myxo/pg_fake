...
| tier1_insert_row_returning/pg_fake | 74.55 us | +43.98% |
| tier1_insert_row_returning/postgres_18 | 98.19 us | +0.07% |
| tier1_insert_row_with_defaults/pg_fake | 63.60 us | +40.36% |
| tier1_insert_row_with_defaults/postgres_18 | 95.13 us | -7.87% |
| tier1_update_row/pg_fake | 53.93 us | +38.85% |
| tier1_update_row/postgres_18 | 91.70 us | -2.31% |
| tier1_serial_identity_insert/pg_fake | 42.83 us | +82.82% |
| tier1_serial_identity_insert/postgres_18 | 32.99 us | -9.71% |
...
| tier1_point_lookup_index_vs_scan/heap_scan/100 | 2.73 us | -5.09% |
| tier1_point_lookup_index_vs_scan/unique_index/100 | 481.85 ns | +0.91% |
| tier1_point_lookup_index_vs_scan/heap_scan/10,000 | 261.82 us | -3.37% |
| tier1_point_lookup_index_vs_scan/unique_index/10,000 | 531.22 ns | +0.84% |
| tier1_foreign_key_insert/pg_fake | 111.93 us | +49.88% |
| tier1_foreign_key_insert/postgres_18 | 181.87 us | +0.02% |
...
| tier1_insert_row_returning | postgres_18 | pg_fake | 🟢 ↑ 1.32x |
| tier1_insert_row_with_defaults | postgres_18 | pg_fake | 🟢 ↑ 1.50x |
| tier1_update_row | postgres_18 | pg_fake | 🟢 ↑ 1.70x |
| tier1_serial_identity_insert | postgres_18 | pg_fake | 🔴 ↓ 1.30x |
...
| tier1_point_lookup_index_vs_scan | heap_scan/100 | unique_index/100 | 🟢 ↑ 5.67x |
| tier1_point_lookup_index_vs_scan | heap_scan/10,000 | unique_index/10,000 | 🟢 ↑ 492.88x |
| tier1_foreign_key_insert | postgres_18 | pg_fake | 🟢 ↑ 1.62x |
...
| tier2_skip_locked_queue_100_rows/pg_fake | 74.68 ms | -82.12% |
| tier2_skip_locked_queue_100_rows/postgres_18 | 48.94 us | +0.47% |
| tier2_lateral_latest_per_parent_100_rows/pg_fake | 7.08 ms | +13.95% |
| tier2_lateral_latest_per_parent_100_rows/postgres_18 | 170.71 us | +46.61% |
...
| tier2_partial_unique_index_100_rows/pg_fake | 108.08 us | +50.16% |
| tier2_partial_unique_index_100_rows/postgres_18 | 546.53 us | -9.28% |
...
| tier2_ordered_filtered_array_agg_100_rows/pg_fake | 215.02 us | +15.05% |
| tier2_ordered_filtered_array_agg_100_rows/postgres_18 | 44.02 us | -0.08% |
...
| tier2_nested_filtered_view_100_rows/pg_fake | 492.08 us | +6.56% |
| tier2_nested_filtered_view_100_rows/postgres_18 | 35.55 us | -3.13% |
...
| tier2_skip_locked_queue_100_rows | postgres_18 | pg_fake | 🔴 ↓ 1525.94x |
| tier2_lateral_latest_per_parent_100_rows | postgres_18 | pg_fake | 🔴 ↓ 41.45x |
...
| tier2_partial_unique_index_100_rows | postgres_18 | pg_fake | 🟢 ↑ 5.06x |
...
| tier2_ordered_filtered_array_agg_100_rows | postgres_18 | pg_fake | 🔴 ↓ 4.88x |
...
| tier2_nested_filtered_view_100_rows | postgres_18 | pg_fake | 🔴 ↓ 13.84x |
...
| tier3_concurrent_uncontended_reads/sequential | 18.59 us | -5.72% |
| tier3_concurrent_uncontended_reads/parallel | 17.24 us | +2.72% |
...
| tier3_concurrent_uncontended_reads | sequential | parallel | 🟢 ↑ 1.08x |
