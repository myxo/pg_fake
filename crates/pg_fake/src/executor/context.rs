...
pub(crate) struct StatementContext {
    ...
    pub(crate) next_subquery_invocation: Arc<std::sync::atomic::AtomicUsize>,
    pub(crate) pending_expressions: Arc<Mutex<Vec<super::subqueries::PendingExpression>>>,
    pub(crate) pending_operations: Arc<Mutex<Vec<super::expressions::PendingOperation>>>,
    pub(crate) pending_evaluations: Arc<Mutex<Vec<super::expressions::PendingEvaluation>>>,
    pub(crate) evaluation_cursor: Option<Arc<Mutex<super::expressions::EvaluationCursor>>>,
    ...
    pub(crate) prepared_limits: Arc<Mutex<Vec<super::query::PreparedLimit>>>,
    pub(crate) prepared_values: Arc<Mutex<Vec<super::query::PreparedValues>>>,
