...
pub const FEATURES: &[Feature] = &[
    ...
    Feature {
        ...
        cases: &[
            ...
            Case {
                ...
                source: "focused local GUC scenario",
                setup: &["SET lock_timeout = '10ms'"],
                sql: "SHOW lock_timeout",
                blocker: BlockerKind::Implementation,
            },
            Case {
                id: "show_timezone_alias",
                source: "focused local GUC scenario",
                setup: &["SET TIME ZONE 'Europe/Paris'"],
                sql: "SHOW TIME ZONE",
                blocker: BlockerKind::Implementation,
            },
            Case {
                id: "reset_application_name",
                source: "focused local GUC scenario",
            ...
            Case {
                ...
                source: "focused local GUC scenario",
                setup: &["SET work_mem = '8MB'", "SET application_name = 'phase3'"],
                sql: "RESET ALL",
                blocker: BlockerKind::Implementation,
            },
            Case {
                id: "set_client_encoding_alias",
                source: "focused local GUC scenario",
                setup: &["SET NAMES 'unicode'"],
    ...
    Feature {
        ...
        cases: &[
            Case {
                id: "primary_recovery_state",
                source: "tests/fixtures/compatibility_utilities.sql",
                setup: &[],
                sql: "SELECT pg_is_in_recovery(), pg_catalog.pg_is_in_recovery()",
                blocker: BlockerKind::Implementation,
            },
            Case {
                id: "pg_lsn_values_and_arithmetic",
                source: "tests/fixtures/compatibility_utilities.sql",
                setup: &[],
                sql: "SELECT '2B/1757980'::pg_lsn::text, '0/16AE7F8'::pg_lsn - '0/16AE7F7'::pg_lsn, ('0/16AE7F7'::pg_lsn + 16::numeric)::text",
                blocker: BlockerKind::Implementation,
            },
            Case {
                id: "regclass_catalog_introspection",
                source: "tests/fixtures/compatibility_utilities.sql",
                setup: &[
